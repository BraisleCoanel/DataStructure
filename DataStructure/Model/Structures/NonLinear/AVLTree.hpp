...
//  DataStructure
//
//  Created by Martinson, Branton on 4/17/18.
...
template <class Type>
BinaryTreeNode<Type> * AVLTree<Type> :: rightLeftRotation (BinaryyTreeNode<Type> * parent)
{
    BinaryTreeNode<Type> * changedNode;
...
{
    BinaryTeeNode<Type> * changedNode;
    changedNode = parent->getLeftNode();
...
BinaryTreeNode<Type> * AVLTree<Type> :: removeNode(BinaryTreeNode<Type> * parent, Type inserted)
{
    ...
    else
    {
        ...
        {
            *parent = *parent->getLeftNode() == nullptr)
        }
